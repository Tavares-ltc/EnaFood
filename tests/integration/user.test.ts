...
import { randCity, randCountry, randEmail, randFirstName, randPassword, randStreetName, randUserName, randZipCode } from "@ngneat/falso";
...
describe("POST /SIGNUP", () => {
  it("should respond with status 401 if no name is given", async () => {
    const address: Address = createRandAddress()
    const invalidBody = {
      email: randEmail(),
